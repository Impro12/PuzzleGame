...
public class LayoutPuzzleButtons : MonoBehaviour {
    ...
    private Sprite[] puzzleButtonBacksideImages;
            ...
            case 0:
                foreach (Button btn in level1Buttons)
                {
                    if (!btn.gameObject.activeInHierarchy)
                    {
                        ...
                        {
                            btn.image.sprite = puzzleButtonBacksideImages[0];
                        }
                        else if(selectedPuzzle == "Transport Puzzle")
                        {
                            btn.image.sprite = puzzleButtonBacksideImages[1];
                        }
                        else if (selectedPuzzle == "Fruit Puzzle")
                        {
                            btn.image.sprite = puzzleButtonBacksideImages[2];
                        }
                    }
                }
